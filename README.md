...
| :--- | :--- | :--- |
| **[`lakam-client`](./lakam-client)** | Angular frontend application source code. | Private |
| **[`lakam-api`](./lakam-api)** | Backend API gateway and business logic. | Private |
| **[`lakam-ai`](./lakam-ai)** | Artificial Intelligence microservice for embeddings & OCR. | Private |
| **[`lakam-blockchain`](./lakam-blockchain)** | Fabric network config and Chaincode. | Private |
